...
$map = "usta_detay.php?id=";
		...
		foreach( $query as $row ){
			...
			<div class='col-md-4'>
					<div class='referans-listele'>
						...
						<a href=".$a."><img src='images/referans.png'></a>


						<ul>
							<li>".$row['usta_adi']."</li>
							<li>".$row['usta_soyadi']."</li>
							<li>".$row['usta_eposta']." tl</li>
							<li>".$row['usta_telefon']."</li>
						</ul>
					</div>
				</div>
	...
	<br>
	<br>
	<a href="usta-ekle.php"><button type="button" style="margin-left: 750px;" class="btn btn-success">Usta Ekle</button></a>
